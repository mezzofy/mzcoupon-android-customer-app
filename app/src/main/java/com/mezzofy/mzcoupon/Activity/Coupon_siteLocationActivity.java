...
public class Coupon_siteLocationActivity extends FragmentActivity implements LocationListener {
    ...
    public void onBackPressed() {
        ...
        super.onBackPressed();
        Intent intent = new Intent(context, Coupon_SiteActivity.class);
        ...
        startActivity(intent);
        overridePendingTransition(0, 0);
        Coupon_siteLocationActivity.this.finish();
    }
